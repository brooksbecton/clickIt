app.
  controller('quizCtrl', ['$firebaseAuth', '$http', '$location', '$rootScope', '$routeParams', '$scope', 'userAccountDialog',
    function ($firebaseAuth, $http, $location, $rootScope, $routeParams, $scope, userAccountDialog) {
      ...
      $scope.googleSignIn = function () {
        console.log("here");
        userAccountDialog.googleSignIn(function (user) {
          $scope.user = user;
          // $scope.$apply();
        });
      }
      ...
      */
      ...
      $scope.showUserDialog = function (ev) {
        userAccountDialog.showUserDialog(ev);
      }

      $scope.signUserOut = function(){
        userAccountDialog.signUserOut();
      }
